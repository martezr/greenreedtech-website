...
![](../../assets/integrating-jenkins-with-gitness-user-management.png)
...
![](../../assets/integrating-jenkins-with-gitness-create-user.png)
...
![](../../assets/integrating-jenkins-with-gitness-user-password.png)
...
![](../../assets/integrating-jenkins-with-gitness-project-members.png)
...
![](../../assets/integrating-jenkins-with-gitness-project-add-members.png)

The Jenkins service account has now been added to the project with read-only permissions. 

![](../../assets/integrating-jenkins-with-gitness-added-member.png)
...
![](../../assets/integrating-jenkins-with-gitness-account-sign-in.png)
...
![](../../assets/integrating-jenkins-with-gitness-user-landing-page.png)

Click the **+ New Token** button to create a new token for the Jenkins service account.

![](../../assets/integrating-jenkins-with-gitness-user-details.png)
...
![](../../assets/integrating-jenkins-with-gitness-unauthenticated-job.png)
...
![](../../assets/integrating-jenkins-with-gitness-jenkins-credentials.png)

With the credentials added, the Jenkins server is now able to successfully connect to the git repository.

![](../../assets/integrating-jenkins-with-gitness-authenticated-job.png)
...
![](../../assets/integrating-jenkins-with-gitness-job-output.png)
...
A potential alternative is using gitness' pipeline functionality to just trigger a corresponding Jenkins job. This feels somewhat redundant but isn't a completely terrible solution so I may well give a try.
