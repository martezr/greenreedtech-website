...
![](../../assets/getting-started-with-gitness/getting-started-with-gitness-initial-login.png)

Provide the required information to create a gitness user account. 

![](../../assets/getting-started-with-gitness/getting-started-with-gitness-signup.png)
...
![](../../assets/getting-started-with-gitness/getting-started-with-gitness-landing-page.png)

Provide a name and description for the project and click the **Create Project** button to create the new project.

![](../../assets/getting-started-with-gitness/getting-started-with-gitness-create-project.png)

We can now launch the create a new repository modal by clicking the **+ New Repository** button.

![](../../assets/getting-started-with-gitness/getting-started-with-gitness-project-landing-page.png)
...
![](../../assets/getting-started-with-gitness/getting-started-with-gitness-create-repo.png)
...
![](../../assets/getting-started-with-gitness/getting-started-with-gitness-repo.png)

We now need to copy the generated API token. The username and API token are used for authenticating to the git repository.

![](../../assets/getting-started-with-gitness/getting-started-with-gitness-credentials.png)
